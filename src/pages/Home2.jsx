...
<section className="creative-together gap no-top" data-aos="fade-up"  data-aos-delay="200" data-aos-duration="300"> 
	<div className="container">
		<div className="gap contact-info-home-two" style={{backgroundImage:"url(https://via.paceholder.com/1290x530)"}}>
			<h2>Let's Create Something
					Creative Together</h2>
			<p>We can't wait to hear from making something beautiful and new! </p>
			<a href="javascript:void(0)" className="lightbox-toggle  magic-hover magic-hover__square button download  button--moema button--text-thick button--text-upper button--size-s"><i className="fa-solid fa-download"></i>Start Consulting</a>
		</div>
	</div>
</section>
<section className="work-experience-two gap" style={{backgroundImage:"url(./assets/img/blur-1.png)"}}>
	<div className="container">
		<div className="hading" data-aos="fade-up"  data-aos-delay="200" data-aos-duration="300">
	  ...
	  <div className="zoom-slider owl-carousel">
	    <div className="item zoom-slider-img">
	    	...
	    	<div className="zoom-slider-data">
	    		<span>December 5, 2023</span><div className="dodgap"></div><span>  John Smith</span>
				...
				<div className="row">
					<div className="col-lg-6" data-aos="fade-up"  data-aos-delay="300" data-aos-duration="400">
						<div className="pricing-plans-tabla">
							<div className="basic-package" style={{backgroundImage:"url(./assets/img/home-2.jpg)"}}>
								<h5>Basic Package</h5>
							...
							<div className="rocket">
								...
								<ul>
									<li><i className="fa-solid fa-check"></i>Website Design</li>
									<li><i className="fa-solid fa-check"></i>Graphic Designing</li>
									<li><i className="fa-solid fa-check"></i>Web Development</li>
