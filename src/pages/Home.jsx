...
const Home = () => {
	...
	async function fetchData(){
		const resp=await fetch('https://portfolio-backend-30mp.onrender.com/api/v1/get/user/65b3a22c01d900e96c4219ae')
		const data=await resp.json()
		setUserData(data.user)
		console.log(data.user,null,2)
		...
		console.log(JSON.stringify(data.user.testimonials,null,2))
	}
	useEffect(()=>{
		fetchData()
	},[])
					...
					<div className="row align-items-center">
						<div className="col-lg-6 col-md-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
							<div className="user-data">
								<h2 >Hello I Am</h2>
								<h1>{userAbout.name}</h1>
								<p>{userAbout.subTitle}</p>
					...
					<div className="row">
						<div className="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
							<div className="about-mee">
								...
								<ul className="social-media-icon"><li><a href="pdf/orix.pdf" className="magic-hover magic-hover__square button button--moema button--text-thick button--text-upper button--size-s"><i className="fa-solid fa-download" target="_blank"></i>Download CV</a></li>
								...
								<ul className="age">
									...
									<li><h6>Address:<span>{userAbout.address}</span></h6></li>
									<li><h6>E-mail:<span>{userData.email}</span></h6></li>
									<li><h6>Phone:<span>{userAbout.phoneNumber}</span></h6></li>
						...
						<div className="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="300" data-aos-duration="400">
							<div className="progress-data">
								<p>{userAbout.description} </p>
								<img alt="sine" src="./assets/img/sine.png"/>
								<div className="progress-bara-data">
									<div className="row">
										{
											skills.slice(0,6).sort((a, b) => a.sequence - b.sequence).map((elem)=>{
												return(
													<>
														<div className="col-lg-6 col-md-6 col-sm-6">
															<div className="home-one-progress">
																<div className="count-time">
																	<h2 className="timer count-title count-number" data-to="50" data-speed="2000">{elem.percentage}</h2><span>%</span>
																</div>
																<h5>{elem.name}</h5>
																<div className="meter cadetblue">
																	<span data-progress="50" style={{ width:`${elem.percentage}%`}}></span>
																</div>
															</div>
														</div>
						 ...
						 <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
							<div className="service-data" >
								<div className="svg-img" >
									...
									<img style={{width:"100%"}} src={elem.image.url} alt="" />
								</div>
								<h5><a className="magic-hover magic-hover__square" href="services-details.html">{elem.name}</a></h5>
								<p>{elem.desc}</p>
							</div>
						</div>
									</>
					...
					<div className="row">
						<div className="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
							<div className="resume-data">
								...
								{
									timeline.filter((elem)=>elem.forEducation==true).map((elem)=>{
										return(
											<>
												<div className="education">
												<h5>{moment(elem.startDate).format("YYYY")} to {moment(elem.endDate).format("YYYY")==="2024"?"Present":moment(elem.endDate).format("YYYY")}</h5>
													<p>{elem.jobTitle}</p>
													<div className="studies">
														<h6>{elem.company_name}</h6>
														<p>{elem.summary}</p>
													</div>
												</div>
						...
						<div className="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
							<div className="resume-data">
								...
								{
									timeline.filter((elem)=>elem.forEducation==false).map((elem)=>{
										return(
											<>
												<div className="education">
													<h5>{moment(elem.startDate).format("YYYY")} to {moment(elem.endDate).format("YYYY")==="2024"?"Present":moment(elem.endDate).format("YYYY")}</h5>
					...
					<div className="row align-items-center">
						...
						<div className="col-lg-7">
							<div className="custome owl-carousel owl-theme">
								{
									testimonials.slice(0,3).map((elem)=>{
										return(
											<>
												<div class="edison item" style={{position:"absolute", top:"-15rem"}} >
													<p>{elem.review}</p>
													<div class="quote-img">
							...
							<div className="blog-data">
								<img alt="blog img" src="https://via.placeholder.com/390x269"/>
									...
									<p>Duis sed odio sit amet nibh vulputate
										...
										amet nibh roach.</p>
									<a className="magic-hover magic-hover__square" href="#"><i className="fa-solid fa-angle-right"></i></a>
							</div>
						</div>
					...
					<div className="row align-items-center">
						<div className="col-lg-4 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
							<div className="e-mail">
								...
								<div><h6>Phone No</h6>
									<a className="magic-hover magic-hover__square" href="mailto:username@domain.com">{userAbout.phoneNumber}</a>
								</div>
							</div>
							<div className="e-mail">
								<div className="icon-box"><i className="fa-solid fa-phone"></i></div>
								<div><h6>Email Address</h6>
									<a className="magic-hover magic-hover__square" href="callto:+(123)4567890">{userData.email}</a>
								</div>
							</div>
							<div className="e-mail">
								<div className="icon-box"><i className="fa-solid fa-location-dot"></i></div>
								<div><h6>Location</h6>
									<a className="magic-hover magic-hover__square" href="javascript:void(0)">{userAbout.address}</a>
								</div>
							</div>
						</div>
						<div className="col-lg-8 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="300" data-aos-duration="400">
							<div className="your-name" style={{backgroundImage: "url(./assets/img/blur-1.png)"}}>
								<form className="one">
