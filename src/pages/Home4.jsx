    ...
    <>
      <div className="tabs js-tabs">
        ...
        <header className="pages-one">
          <a href="javascript:void(0)" className="bar-menu"><i className="fa-solid fa-bars"></i></a>
          ...
          <div className="header-home-one tabs-nav__list">
            ...
            <div className="tabs-nav js-tabs-nav" id="fade-example">
              <ul className="menu-item main-menu tabs-nav__list">
                <li className="active tabs-nav__item js-tabs-item"><a href="#tab-1" className="tabs-nav__link js-tabs-link magic-hover magic-hover__square"><i className="icon-home"></i><span>Home</span></a></li>
                <li className="tabs-nav__item js-tabs-item"><a href="#tab-2" className="tabs-nav__link js-tabs-link magic-hover magic-hover__square"><i className="icon-user"></i><span>About Me</span></a></li>
                <li className="tabs-nav__item js-tabs-item"><a href="#tab-3" className="tabs-nav__link js-tabs-link magic-hover magic-hover__square"><i className="icon-graduation"></i><span>Experience</span></a></li>
                <li className="tabs-nav__item js-tabs-item"><a href="#tab-4" className="tabs-nav__link js-tabs-link magic-hover magic-hover__square"><i className="icon-briefcase"></i><span>Portfolio</span></a></li>
                <li className="tabs-nav__item js-tabs-item"><a href="#tab-5" className="tabs-nav__link js-tabs-link magic-hover magic-hover__square"><i className="icon-folder"></i><span>News</span></a></li>
                <li className="tabs-nav__item js-tabs-item"><a href="#tab-6" className="tabs-nav__link js-tabs-link magic-hover magic-hover__square"><i className="icon-envelope-open"></i><span>Contact</span></a></li>
              </ul>
              <span className="tabs-nav__drag js-tabs-drag"></span>
            </div>

            <div className="share">
              <a className="magic-hover magic-hover__square" href="#"><i className="icon-cursor"></i></a>
          ...
          <div className="mobile-nav" id="mobile-nav" style={{display: "block"}}>
            ...
            <ul className="menu-item main-menu tabs-nav__list">
              <li className="active tabs-nav__item js-tabs-item"><a href="#tab-1" className="tabs-nav__link js-tabs-link new-tabe nav-anim magic-hover magic-hover__square"><i className="icon-home"></i><span>Home</span></a></li>
              <li className="tabs-nav__item js-tabs-item"><a href="#tab-2" className="tabs-nav__link js-tabs-link new-tabe nav-anim magic-hover magic-hover__square"><i className="icon-user"></i><span>About Me</span></a></li>
              <li className="tabs-nav__item js-tabs-item"><a href="#tab-3" className="tabs-nav__link js-tabs-link new-tabe nav-anim magic-hover magic-hover__square"><i className="icon-graduation"></i><span>Experience</span></a></li>
              <li className="tabs-nav__item js-tabs-item"><a href="#tab-4" className="tabs-nav__link js-tabs-link new-tabe nav-anim magic-hover magic-hover__square"><i className="icon-briefcase"></i><span>Portfolio</span></a></li>
              <li className="tabs-nav__item js-tabs-item"><a href="#tab-5" className="tabs-nav__link js-tabs-link new-tabe nav-anim magic-hover magic-hover__square"><i className="icon-folder"></i><span>News</span></a></li>
              <li className="tabs-nav__item js-tabs-item"><a href="#tab-6" className="tabs-nav__link js-tabs-link new-tabe nav-anim magic-hover magic-hover__square"><i className="icon-envelope-open"></i><span>Contact</span></a></li>
            </ul>

            <a className="magic-hover magic-hover__square" href="JavaScript:void(0)" id="res-cross"></a>
                ...
                <div className="user-info">
                  <img alt="profile" src="https://via.placeholder.com/247x296"/>
                    ...
                    <ul className="social-media">
                      <li><a className="magic-hover magic-hover__square" href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                      <li><a className="magic-hover magic-hover__square" href="#"><i className="fa-brands fa-twitter"></i></a></li>
                      <li><a className="magic-hover magic-hover__square" href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                      <li><a className="magic-hover magic-hover__square" href="#"><i className="fa-brands fa-stumbleupon"></i></a></li>
                    </ul>
                </div>
              </div>
            </div>
        ...
        <div className="content-area tabs-content js-tabs-wrap">
          <section id="tab-1" className="profile-info tab js-tabs-content active" style={{backgroundImage: "url(./assets/img/background.png)"}}>
            <div className="container">
              ...
              <div className="row">
                <div className="col-xl-8 col-lg-12">
                  ...
                  <div className="load-button">
                    <a href="#" className="button button--moema button--text-thick button--text-upper button--size-s"><i className="fa-solid fa-spinner"></i> Load More</a>
                  </div>
                        ...
                        <img alt="news-img" src="https://via.placeholder.com/400x242"/>
                          ...
                          <div className="box">
                            <div className="flex-img">
                              <img alt="popup-img" src="./assets/img/orix-popup.jpg"/>
