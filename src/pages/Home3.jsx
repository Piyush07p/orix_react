            ...
            <div className="col-lg-5" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
              <div className="hello-im">
                ...
                <ul className="social-media-footer head">
                  <li><a className="magic-hover magic-hover__square" href="#"><i className="fa-brands fa-facebook-f fb"></i></a></li>
                  <li><a className="magic-hover magic-hover__square" href="#"><i className="fa-brands fa-twitter tw"></i></a></li>
                  <li><a className="magic-hover magic-hover__square" href="#"><i className="fa-brands fa-vimeo-v vi"></i></a></li>
                </ul>
              </div>
            </div>
            <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
              <div className="home-img">
                <img alt="man" src="./assets/img/home-img-3.png"/>
              </div>
            </div>
          </div>
        </div>
